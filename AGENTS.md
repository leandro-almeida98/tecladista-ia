...
This project is indexed by GitNexus as **tecladista-ia** (22 symbols, 17 relationships, 0 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
